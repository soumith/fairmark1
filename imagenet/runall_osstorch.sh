...
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 4 -batchSize 256
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 8 -batchSize 256
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 4 -batchSize 512
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 8 -batchSize 512
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 4 -batchSize 1024
th main.lua -netType alexnetowtbn -backend cudnn -nGPU 8 -batchSize 1024
...
th main.lua -netType overfeat -backend cudnn -nGPU 4 -batchSize 256
th main.lua -netType overfeat -backend cudnn -nGPU 8 -batchSize 256
th main.lua -netType overfeat -backend cudnn -nGPU 4 -batchSize 512
th main.lua -netType overfeat -backend cudnn -nGPU 8 -batchSize 512
...
th main.lua -netType vgg -backend cudnn -nGPU 4 -batchSize 256
th main.lua -netType vgg -backend cudnn -nGPU 8 -batchSize 256
th main.lua -netType vgg -backend cudnn -nGPU 4 -batchSize 512
th main.lua -netType vgg -backend cudnn -nGPU 8 -batchSize 512
...
th main.lua -netType googlenet -backend cudnn -nGPU 4 -batchSize 256
th main.lua -netType googlenet -backend cudnn -nGPU 8 -batchSize 256
th main.lua -netType googlenet -backend cudnn -nGPU 4 -batchSize 512
th main.lua -netType googlenet -backend cudnn -nGPU 8 -batchSize 512
